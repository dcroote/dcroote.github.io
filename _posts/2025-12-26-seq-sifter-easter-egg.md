...
<blockquote>
<p>
Fancy some sleuthing for charity? 🔍 For years we've included a graphic in IgGenix, Inc presentations to represent our patented SEQ SIFTER™ single-cell RNA-sequencing antibody discovery platform. Well, all of this time there has been a little something hidden… 😉
</p>
<p>
In the holiday spirit, I will donate $50 to the charity of choice for the first one to find it and comment below. Good luck!
</p>
...
<script>
  ...
  function validateAnswer() {
    // minified https://github.com/enyo/md5 via https://stackoverflow.com/a/33486055
    ...
    const userAnswer = document.getElementById('userAnswer').value.toLowerCase().slice(0,100);
    const saltedAnswer = userAnswer + "4b8bb207-37cf-4c4d-b1c1-ade367eb6dc8"

    const hashedSaltedAnswer = MD5(saltedAnswer).toString();

    const correctHashedAnswer = "ec021d96fbc0d3779dc86c854dbd88fb";
    var outputText = "";
    if ( hashedSaltedAnswer === correctHashedAnswer ) {
        outputText = "Correct";
    } else {
        outputText = "Incorrect";
    }
    document.getElementById('validatedAnswer').textContent = outputText;
