...
tags: [engineering, coffee]
discuss_on_twitter: https://x.com/DerekCroote/status/1804577989520400477
---
...
<img loading="lazy" decoding="async" src="/images/cold_brew/cold_brew_kit.png" alt="Primula cold brew starter kit in use" class="centered_img" width="324" height="331" />
...
<video src="/images/cold_brew/cold_brew_vortex.mp4" class="centered_img" width="270" height="480" poster="/images/cold_brew/cold_brew_coffee_vortex_poster.png" controls preload="none"></video>
...
<img loading="lazy" decoding="async" src="/images/cold_brew/homemade_stir_plate_v2.png" alt="Homemade stir plate - version 2" class="centered_img" width="480" height="665" />
...
<img loading="lazy" decoding="async" src="/images/cold_brew/chemistry_stir_plate_solution.png" alt="Making cold brew coffee with a chemistry stir plate" class="centered_img" width="288" height="408" />
