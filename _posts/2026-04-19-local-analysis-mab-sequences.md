...
<img loading="lazy" decoding="async" src="/images/lambs/screenshot_lambs_single_mab_analysis.png" alt="Screenshot of LAMBS single mAb analysis" class="centered_img" width="800" height="813" onclick="openImageModal(this.src)" style="cursor: zoom-in" />
